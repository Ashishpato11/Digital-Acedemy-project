...
<div class="contaner">
  <div class="row justify-content-center">
    <div class="col-sm-5 mt-4">
      ...
      <div class="card p-4">
        <label class="text-center text-xl " for="">Instructor Detail </label>
        <img src="/upload/instruct_images/{{$data->photo}}" class="rounded-circle" height="40%" width="30%">
          <div class="card-body ">
            <div class="row">
            ...
            <div class="row">
              <div class="col-lg-3 font-weight-bold col-md-4 label">Passion</div>
              <div class="col-lg-9 col-md-8">{{$data->skill}}</div>
            </div>
            <div class="row">
              <div class="col-lg-3 font-weight-bold col-md-4 label">About</div>
              <div class="col-lg-9 col-md-8">{{$data->workexperience}}</div>
            </div>
  
            <div class="row">
              <div class="col-lg-3 font-weight-bold col-md-4 label">Qualification</div>
              <div class="col-lg-9 col-md-8">{{$data->qualification}}</div>
            </div>
            <div class="row">
