            ...
            <form action="" method="get">
                <div class="card-header">     
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{ route("admin.course.list") }}'" class="btn btn-default btn-sm">Reset</button>
                    </div>          
                        ...
                        @forelse ($courses as $course)
                            <tr>
                                			...
                                			<td>   
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                      <a class="dropdown-item" href="/admin/course/section/create/{{ $course->id }}">Add Section</a>
                                ...
                                <td>
                                    ...
                                    <a href="/admin/course/{{ $course->id }}/delete" class="text-danger w-4 h-4 mr-1">
