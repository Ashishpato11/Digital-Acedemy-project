    ...
    <div class="container">
        <div class="row mb-8">
            ...
            <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
                ...
                <p class="me-xl-13 mb-5">{{$course->short_description}}</p>
                ...
                <div class="d-md-flex align-items-center mb-5">
                    <div class="border rounded-circle d-inline-block mb-4 mb-md-0 me-md-6 me-lg-4 me-xl-6">
                        <div class="p-2">
                            <img src="/upload/instruct_images/{{$course->user->photo}}" class="rounded-circle" width="68" height="68"  >
                        </div>
                    </div>

                    <div class="mb-4 mb-md-0 me-md-8 me-lg-4 me-xl-8">
                        <h6 class="mb-0">Created by</h6>
                        <a href="#" class="font-size-sm text-gray-800">{{$course->user->name}}</a>
                    </div>

                    <div class="mb-4 mb-md-0 me-md-8 me-lg-4 me-xl-8">
                        <h6 class="mb-0">Categories</h6>
                        <a href="#" class="font-size-sm text-gray-800">{{$course->category->title}}</a>
                    </div>
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-overview" role="tabpanel"      aria-labelledby="pills-overview-tab">
                        ...
                        {{-- <p class=" line-height-md" id="readcollapseExample">{{$course->short_description}}</p> --}}
                        <p class="collapse mb-6 line-height-md" id="readcollapseExample">{!! $course->description !!}</p>
                        <a class="text-teal read-more h6 d-inline-block" data-bs-toggle="collapse" href="#readcollapseExample" role="button" aria-expanded="false" aria-controls="readcollapseExample">
                    ...
                    <div class="tab-pane fade" id="pills-instructor" role="tabpanel" aria-labelledby="pills-instructor-tab">
                        ...
                        <div class="d-flex align-items-center mb-6">
                            <div class="d-inline-block rounded-circle border me-6 p-2">
                                <div class="avatar avatar-size-120">
                                    ...
                                    <img src="/upload/instruct_images/{{$course->user->photo}}" alt="..." class="avatar-img rounded-circle">
                                </div>
                            </div>
                            <div class="media-body">
                                <h4 class="mb-0">{{$course->user->name}}</h4>
                                <span>{{$course->user->skill}}</span>
                            </div>
                        </div>
                        ...
                        <p class="mb-6 line-height-md">{{$course->user->workexperience}}</p>
                ...
                <div class="d-block rounded border p-2 shadow mb-6">
                    ...
                    <div class="pt-5 pb-4 px-5 px-lg-3 px-xl-5">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <del class="ms-3 ">${{$course->compare_price}}</del>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 pb-4 pb-md-5" style="padding-right:15px;padding-left:15px;">
                ...
                <div class="card border shadow-dark-hover p-2 sk-fade">
                    ...
                    <div class="card-zoom position-relative">
                        <a href="/front/singlecourse/{{$relCourse->id}}" class="card-img sk-thumbnail img-ratio-3 d-block">
                            <img src="/upload/course/{{$relCourse->thumbnail}}" class="card-img-top"  height="200px" width="150px">
                        </a>

                        <span class="sk-fade-right badge-float bottom-0 right-0 mb-2 me-2">
                            <del class="h5 mb-0 text-white">${{$relCourse->compare_price}}</del>
                            <ins class="h5 mb-0 text-white">${{$relCourse->price}}</ins>
                        </span>
                    </div>
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        <!-- Preheading -->
                        <a href="/front/singlecourse/{{$course->id}}"><span class="mb-1 d-inline-block text-gray-800">{{$relCourse->category->title}}</span></a>
                        <a href=""><input type="submit" class="button" value="Add Cart"></a>
                        <!-- Heading -->
                        <div class="position-relative">
                            <a href="/front/singlecourse/{{$course->id}}" class="d-block stretched-link"><h5 class="">{{$relCourse->title}}</h5></a>
