            ...
            <div class="col-md pb-4 pb-md-7">
                ...
                <div class="card border shadow p-2 lift sk-fade">
                    ...
                    <div class="card-footer px-2 pb-2 mb-1 pt-4 position-relative">
                        <a href="/front/singlecourse/{{$course->id}}" class="d-block">
                        ...
                        <!-- Preheading -->
                        <a href="/front/singlecourse/{{$course->id}}"><span class="mb-1 d-inline-block text-gray-800">Created By : {{$course->user->name}}</span></a>
