 <!-- CATEGORIES
        ...
        <div class="container">
            ...
            <div class="mx-n4" data-flickity='{"pageDots": false, "prevNextButtons": true, "cellAlign": "left", "wrapAround": true, "imagesLoaded": true}'>
                ...
                <div class="col-6 col-lg-4 col-xl-3 pt-2 pb-4 px-md-4" data-aos="fade-up" data-aos-delay="50">
                    <!-- Card -->
                    <a href="/front/categorycourse/{{$category->id}}" class="card icon-category card-border-hover icon-category border shadow-dark-hover p-md-5 p-3 text-center lift">
                        <!-- Image -->
                        <div class="position-relative" style="color: #f0e7f3;">
                            ...
                            <!-- Icon BG -->
                            <img src="/upload/category/{{$category->photo}}" class="card-img-top"  height="200px" width="150px">
    ...
    {{-- <section class="pt-5 pb-9 py-md-11" >
        <div class="container">
            ...
            <div class="row mb-3">
                @if (getCategories()->isNotEmpty())
                    @foreach (getCategories() as $category )
                <div class="col-lg-3 pb-4 pb-md-3">
                    <!-- Card -->
                    <div class="card border rounded-lg shadow  lift sk-fade">
                        <div class="row">
                            <div class="col-md-5 col-lg-auto rounded-lg d-flex">
                                ...
                                <div class="card-zoom d-flex position-relative mw-lg-200p mw-xl-260p">
                                    ...
                                    <a href="course-single-v1.html" class="d-flex"> <img src="/upload/category/{{$category->photo}}" class="card-img-top"  height="200px" width="150px"></a>

                                    <span class="badge sk-fade-bottom badge-lg badge-tangerine badge-pill badge-float bottom-0 left-0 mb-4 ms-4">
                                        <span class="text-white text-uppercase fw-bold font-size-xs">{{$category->title}}</span>
                                    </span>
                                </div>
                            </div>
            ...
            <div class="text-center">
                <a href="course-list-v5.html" class="btn btn-gigas btn-x-wide rounded-lg lift">VIEW ALL COURSES</a>
            </div>
        </div>
    </section> --}}
    ...
    <section class="pt-5 pb-9 py-md-11">
        <div class="container">
                    ...
                    <div class="card border shadow p-2 lift sk-fade">
                        ...
                        <div class="card-zoom position-relative">
                            <div class="badge-float sk-fade-top top-0 right-0 mt-4 me-4">
                                <a href="/front/singlecourse/{{$course->id}}" class="btn btn-xs btn-dark text-white rounded-circle lift opacity-dot-7 me-1 p-2 d-inline-flex justify-content-center align-items-center w-36 h-36">
                                    <!-- Icon -->
                            ...
                            <a href="/front/singlecourse/{{$course->id}}" class="card-img sk-thumbnail d-block">
                                <img src="/upload/course/{{$course->thumbnail}}" class="card-img-top"  height="200px" width="150px">
                            </a>
                        ...
                        <div class="card-footer px-2 pb-2 mb-1 pt-4  position-relative">
                            <a href="/front/singleinstructor/{{$course->user->id}}" class="d-block">
                                <div class="avatar sk-fade-right avatar-xl badge-float position-absolute top-0 right-0 mt-n10 me-5 rounded-circle shadow border border-white border-w-lg">
                                    <img src="/upload/instruct_images/{{$course->user->photo}}" class="card-img-top rounded-circle" height="60px" width="50px"  >
                                </div>
                            </a>
                            <a href=""><input type="submit" class="button" value="Add Cart"></a>
                            ...
                            <div class="position-relative">
                                <a href="/front/singlecourse/{{$course->id}}" class="d-block stretched-link"><h4 class="">{{$course->title}}</h4></a>
                                
                                <span class="mb-1 d-inline-block text-gray-800">Created By: {{$course->user->name}}</span>
                                ...
                                <div class="row mx-n2 align-items-end">
                                    ...
                                    <div class="col-auto px-2 text-right">
                                        <del class="font-size-sm">${{$course->compare_price}}</del>
            ...
            <div class="text-center">
                <a href="/front/shop" class="btn btn-gigas btn-x-wide rounded-lg lift">VIEW ALL COURSES</a>
            </div>
        </div>
    </section>