...
<head>
  ...
  <link href="{{asset('/instruct-assets/vendor/summernote/summernote.min.css')}}" rel="stylesheet">
  <link rel="stylesheet" href="{{asset('/instruct-assets/vendor/select2/css/select2.min.css')}}">
...
<body>
    ...
    <nav class="header-nav ms-auto">
        <li class="nav-item dropdown pe-3">
          <a class="nav-link nav-profile d-flex align-items-center pe-0 mb-4" href="#" data-bs-toggle="dropdown">
            <img height="45px" width="45px" src="{{ (!empty($profileData->photo)) ? url('upload/instruct_images/'.$profileData->photo) : url('upload/unnamed.jpg')}}" alt="Profile" class="rounded-circle">
  ...
  <script src="{{asset('/instruct-assets/vendor/summernote/summernote.min.js')}}"></script>
  <script src="{{asset('/instruct-assets/vendor/select2/js/select2.min.js')}}"></script>
